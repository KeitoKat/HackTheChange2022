    ...
    return(
        <Fragment>
            <div class="container justify-content-center col gap-8 col">
                ...
                <div class="container d-flex text-start col gap-8">
                <p class="text-wrap">{host.country}</p>
                </div>
                ...
                <div class="container my-5">
                    <div class="row">
                        <div class="col">
                            <div class="row">
                                <div class="col">
                                    <h5 class="mt-3 text-wrap">Wondeful home hosted by {host.hostName}</h5>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">{host.hostName}'s thoughts</h5>
